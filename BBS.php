<?php
//4-1：データベースへ接続
$dsn =   'mysql:dbname=tb210129db;host=localhost';
$user =  'tb-210129';
$password =  'XTDNXyrN5n';
...
<head>
	<meta charset="utf-8">
  <title>Free Online Forum</title>
  <link rel="stylesheet"  type="text/css" href="BBS.css">
</head>
<body>
  <div class="screen">
    <h1>Free Online Forum</h1>
  </div>
  <form method = "post">
    <br>
    <br>
    <div class="form-item"align="center">
      <h3>【 投稿 】</h3>
      <br>
      <p><input type="text" name="name" placeholder="名前" value= "<?php if(isset($username)) {echo $username;}?>"></p>
      <p><input type="text" name="comment" placeholder="コメント" value= "<?php if(isset($text)) {echo $text;}?>"></p>
      <p><input type="password" v-show-password-input name="password" placeholder="パスワード"	></p>
      <p><input type="hidden" name="edit_No" placeholder="編集番号を反映" value= "<?php if(isset($editnumber)) {echo $editnumber;}?>"></p>
    </div>
  ...
  <form method = "post">
    <div class="form-item"align="center">
      ...
      <p><input type="password" name="del_password" placeholder="パスワード"></p>
    </div>
    <div class="button-panel"align="center">
  ...
  <form method = "post">
    <div class="form-item"align="center">
      ...
      <p><input type="password" name="edit_password" placeholder="パスワード"></p>
    </div>
    <div class="button-panel"align="center">
